...
#ifndef LISTA_SEQUENCIAL_ESTATICA_H
#define LISTA_SEQUENCIAL_ESTATICA_H
...
/*
 Compara o item x com y, retornando:
    1 => Caso x > y
    0 => Caso x = y
    -1 => Caso x < y
*/
...
/*
    Objetivo: Insere o item passado como parametro na lista passada.
              ...
              a funçao INSERIR retorna false.
*/
...
/*
    ...
    Caso encontre, retorna a posiçao (entre 0 e tamanho = -1).
...
// Pre-condiçao: 0 <= n < tamanho
ITEM enesimo(int n, LISTA *l);

/*
    Objetivo: Altera o item contido em uma dada posiçao da lista.
    Caso a posiçao exista, retorna true. Caso nao exista,
    a alteraçao nao sera feita e retorna false
*/
...
#endif //LISTA_SEQUENCIAL_ESTATICA_H
