...
caminho = "C:\\Users\\guilh\\OneDrive\\Documents\\3_periodo_ufs\\IC - Daniel\\Treinamento Phyton\\perceptron\\classificacao_estimators\\classi_estimators\\classi_esti150034\\normalizado150034_com_gesture_1_e_0.csv"
...
def padroniza_ch0(valor):
    return tf.divide(tf.subtract(tf.cast(valor, tf.float32), tf.constant(0.09445)), tf.constant(0.09721))
def padroniza_ch1(valor):
    return tf.divide(tf.subtract(tf.cast(valor, tf.float32), tf.constant(0.25871)), tf.constant(0.13669))
def padroniza_ch2(valor):
    return tf.divide(tf.subtract(tf.cast(valor, tf.float32), tf.constant(0.05282)), tf.constant(0.13598))
def padroniza_ch3(valor):
    return tf.divide(tf.subtract(tf.cast(valor, tf.float32), tf.constant(0.00196)), tf.constant(0.17437))
